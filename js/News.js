    $(document).ready(function(){
        ...
        var prev_html = '<img border=0 src="img/arrowleft.png" width="10" height="10" style="vertical-align:middle">'; //the html inside <a>  for previous news
        var next_html = '<img border=0 src="img/arrowright.png" width="10" height="10" style="vertical-align:middle">'; //the html inside <a>  for next news
